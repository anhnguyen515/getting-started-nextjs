...
type InputVariants = "primary" | "secondary" | "danger" | "success" | "warning";
type InputLevels = "normal" | "outline" | "text"; // Added text level
type InputSizes = "sm" | "md" | "lg"; // Added sizes

interface InputProps {
  variant?: InputVariants;
  level?: InputLevels;
  size?: InputSizes; // Added size prop
  className?: string;
  value: string;
...
const Input = ({
  ...
  const classes = twMerge(
    "block w-full rounded-md focus:outline-none focus:ring-2 focus:ring-offset-0 transition ease-out duration-300", // Updated focus:ring-offset-2 to focus:ring-offset-0
